...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `members`(`id`,`first_name`, `last_name`, `email`, `gender` ,`contact_no`) VALUES (NULL,'$first_name','$last_name','$email','$gender','$contact_no')";
...
<head>
   ...
   <title>EverGreen Club Member Application</title>
</head>

<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00ff5573;">
      <b>EverGreen Club Member Application
   </b></nav>
